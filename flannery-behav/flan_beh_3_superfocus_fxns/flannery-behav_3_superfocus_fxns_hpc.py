# # # # # # # # # # # # # # # #
# # Run Superfocus fxn annotations from reads - for Flannery et al Child behavioral metagenomics samples
# # Run from Deep Thought folder - /scratch/user/lidd0026/flannery-behav/flan_beh_3_superfocus_fxns
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/user/lidd0026/flannery-behav/flan_beh_2_fastp_qc'

# set working directory
workDir = '/scratch/user/lidd0026/flannery-behav/flan_beh_3_superfocus_fxns'
...
table = pd.read_csv(os.path.join(READDIR,'METADATA-Flannery-behav-SraRunTable.txt'), sep=',')
