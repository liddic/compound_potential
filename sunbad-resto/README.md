## Workflow on DeepThought HPC - Sun & Badgley post-mining forest restoration case study
...
**Step 1. Inspect & download screened fasta files from MG-RAST**

Using MG-RAST tools, inspect available files for this case study (project mgp16379)
...
Raw fastq files are not available, so instead download screened fasta files.
