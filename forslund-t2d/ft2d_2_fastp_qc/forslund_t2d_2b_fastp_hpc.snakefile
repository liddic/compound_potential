...
Run from Deep Thought folder - /scratch/user/lidd0026/forslund-t2d/ft2d_2_fastp_qc
...
READDIR = '/scratch/user/lidd0026/forslund-t2d/ft2d_1_meta_raw'

# directory for QC outputs
OUTDIR = '/scratch/user/lidd0026/forslund-t2d/ft2d_2_fastp_qc'
