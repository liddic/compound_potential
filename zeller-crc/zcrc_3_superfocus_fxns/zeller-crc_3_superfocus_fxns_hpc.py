# # # # # # # # # # # # # # # #
# # Run Superfocus fxn annotations from reads - for Zeller et al Colorectal cancer metagenomics samples
# # Run from Deep Thought folder - /scratch/user/lidd0026/zeller-crc/zcrc_3_superfocus_fxns
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/user/lidd0026/zeller-crc/zcrc_2_fastp_qc'

# set working directory
workDir = '/scratch/user/lidd0026/zeller-crc/zcrc_3_superfocus_fxns'
...
table = pd.read_csv(os.path.join(READDIR,'zeller-crc-sra-run-list.txt'), sep=',')
