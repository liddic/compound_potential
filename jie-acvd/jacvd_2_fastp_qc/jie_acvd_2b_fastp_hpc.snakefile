...
Run from Deep Thought folder - /scratch/user/lidd0026/jie-acvd/jacvd_2_fastp_qc
...
READDIR = '/scratch/user/lidd0026/jie-acvd/jacvd_1_meta_raw'

# directory for QC outputs
OUTDIR = '/scratch/user/lidd0026/jie-acvd/jacvd_2_fastp_qc'
