# # # # # # # # # # # # # # # #
# # Run Superfocus fxn annotations from reads - for Jie et al Atherosclerotic cardiovascular disease metagenomic samples
# # Run from Deep Thought folder - /scratch/user/lidd0026/jie-acvd/jacvd_3_superfocus_fxns
# # # # # # # # # # # # # # # #
...
READDIR = '/scratch/user/lidd0026/jie-acvd/jacvd_2_fastp_qc'

# set working directory
workDir = '/scratch/user/lidd0026/jie-acvd/jacvd_3_superfocus_fxns'
...
table = pd.read_csv(os.path.join(READDIR,'jie-ACVD-sra-run-list-AVAILABLE.txt'), sep=',')
